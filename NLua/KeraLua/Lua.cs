...
namespace KeraLua
{
	...
	public static partial class Lua
	{
		...
		{
      return NativeMethods.luaL_loadstring (luaState, System.Text.Encoding.UTF8.GetString(chunk));
		}
		...
		{
			return NativeMethods.luanet_loadbuffer (luaState, System.Text.Encoding.UTF8.GetString(buff), 0, name);
		}
